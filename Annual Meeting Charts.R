...
netMigCluster=readr::read_csv("netMigClusterAnnual")
## Plot 1 ##
...
plot_1=data%>%
  ...
  mutate(year=recode(year, "2004:2006=1;2007:2009=2; 2010:2014=3"),
         year=ordered(year, levels=1:3, labels=c("2004 to 2006", "2007 to 2009","2010 to2014")))%>%
  ...
  labs(title="Net Migration Rates by Recession Period, 2004 to 2014")
plot_1
